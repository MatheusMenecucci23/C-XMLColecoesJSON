...
namespace _01._03
{
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("--------DEPOIS DE DESSERIALIZAR---------");
