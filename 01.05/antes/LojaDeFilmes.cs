...
namespace _01._05
{
    ...
    public class Diretor : ISerializable
    {
        ...
        {
            //nameof assim você consegue pegar o nome do atributo da classe, e caso um dia precisar mudar fica mais fácil
            info.AddValue(nameof(Nome), Nome);
            info.AddValue(nameof(NumeroFilmes), NumeroFilmes);
            info.AddValue("Resumo", $"Nome: {Nome}, Númeor de Filmes: {NumeroFilmes}");
