...
namespace _02._02._1
{
    class Program
    {
        ...
        {
            //não é possível fazer alterações na lista, visto que ela agora é apenas para leitura
            ...
            //loja.Filmes.Add(new Filme(new Diretor("Zé Ninguem", 3), "Um novo filme", "2018"));
            //Imprimir(loja);
        }

        private static void Imprimir(LojaDeFilmes loja)
        {
